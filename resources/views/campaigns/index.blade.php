                    ...
                    <ul class="list bg-base-100 rounded-box shadow-md">
                        ...
                        <li class="list-row flex justify-between">
                                ...
                                <div class="flex">
                                    ...
                                    <x-form :action="route('templates.show' , $campaign['id'])" get>
                                    ...
                                    <x-form :action="route('templates.edit' , $campaign['id'])" get>
                                        <button class="btn btn-square btn-ghost">
                                    ...
                                    <x-form :action="route('templates.destroy', $campaign['id'])" delete class=" py-0" onsubmit="return(confirm('Tem certeza que deseja excluir?'))">
