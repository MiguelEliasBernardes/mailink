            ...
            <div class="bg-white w-3/4 mx-auto  dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div class="p-6 text-gray-900 dark:text-gray-100 flex flex-col gap-10">
                    ...
                    <div class=" flex justify-between">
                        <x-link-button :href="route('email-list.create')"  class="w-2/6 btn" >
                            Criar Lista
                        </x-link-button>

                        <x-form :class="'!items-end !w-1/2'" :action="route('email-list.index')" get>
                    ...
                    <ul class="list bg-base-100 rounded-box shadow-md">
                        ...
                        <li class="p-4 pb-2 text-xs opacity-60 tracking-wide">Listas Cadastradas</li>
                        ...
                        <li class="list-row flex justify-between">
                                <div>
                                    <div>{{ $list['name'] }}</div>
                                    <div class="text-xs uppercase font-semibold opacity-60">{{ $list['email_users_count'] }} E-mails cadastrados</div>
                                </div>

                                <div class="flex">

                                    <x-form :action="route('customer-email.index')" get class=" py-0">
                                    ...
                                    <x-form :action="route('email-list.destroy', $list['id'])" delete class=" py-0" onsubmit="return(confirm('Tem certeza que deseja excluir?'))">
